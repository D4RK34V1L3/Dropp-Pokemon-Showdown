...
exports.commands = {
	...
	shop: function (target, room, user) {
		...
		this.sendReplyBox(
			'<center><h3><b><u>Tienda Virtual</u></b></h3><table border="1" cellspacing="0" cellpadding="3" target="_blank"><tbody>' +
			...
			'<tr><td>Chatroom</td><td>Compra una Sala de chat. Será pública o privada en función del motivo de su compra. Si se detecta spam u Otros contenidos inapropiados a ella , sera Borrada.</td><td>10000</td></tr>' +
                        '<tr><td>Avatar</td><td>Compra un avatar personalizado. Preferiblemente debe ser una imagen de pequeñas dimensiones y acorde a las reglas del servidor. Contactar con un Admin para obtener este artículo.</td><td>8000</td></tr>' +
